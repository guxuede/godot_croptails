...
var main_scene_path:String = "res://scenes/main_scenes.tscn"
var game_scene_root_path:String = "/root/MainScenes"
var main_scene_level_root_path = "/root/MainScenes/GameRoot/LevelRoot"
...
func load_main_scene_container()->void:
	if get_tree().root.has_node(game_scene_root_path):
		return
