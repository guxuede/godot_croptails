...
func _ready():
	...
	_ctrl_draggable_inventory_item.mouse_entered.connect(_on_item_mouse_entered.bind(_ctrl_draggable_inventory_item))
	_ctrl_draggable_inventory_item.mouse_exited.connect(_on_item_mouse_exited.bind(_ctrl_draggable_inventory_item))
